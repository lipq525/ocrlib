...
{ // chinese
	...
	const char* datapath{ "D:/Tessearct/OCR_Test-master/test_data/tessdata/" };
#else
	...
	fprintf(stdout, "OCR version: %s\n", api->Version());
	// Open input image with leptonica library
#ifdef _MSC_VER
	//Pix* image = pixRead("E:/GitCode/OCR_Test/test_data/chi_sim_1.png");
	Pix* image = pixRead("D:/Tessearct/OCR_Test-master/test_data/lixin.png");
#else
...
{ // english
	...
	Pix* image = pixRead("D://Tessearct//OCR_Test-master//test_data//eng_1.png");
#else
